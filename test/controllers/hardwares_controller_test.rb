...
class HardwaresControllerTest < ActionController::TestCase
  ...
  test "should create hardware" do
    assert_difference('Hardware.count') do
      post :create, hardware: { barcode: @hardware.barcode, description: @hardware.description, location: @hardware.location, name: @hardware.name, sn: @hardware.sn }
    end
  ...
  test "should update hardware" do
    patch :update, id: @hardware, hardware: { barcode: @hardware.barcode, description: @hardware.description, location: @hardware.location, name: @hardware.name, sn: @hardware.sn }
    assert_redirected_to hardware_path(assigns(:hardware))
  end
